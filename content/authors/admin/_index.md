...
bio: My research interests include representation, redistricting and gerrymandering, and survey research.

interests:
- Political Representation
- Ridistricting and Gerrymandering
- Survey Research
...
- icon: envelope
  icon_pack: fas
  link: '"mailto:tsteelman@unc.edu"'  # For a direct email link, use "mailto:tsteelman@unc.edu".
- icon: twitter
  icon_pack: fab
